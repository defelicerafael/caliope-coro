<?php
    ...
    $collection_id = $pedido[0]['id_mercado_pago'];
   ...
   // $mail->SMTPDebug = 2;
    ...
    if($estadoEnvio){
        $sql = new Sql;
        echo "EMAIL A larondaong@gmail.com ENVIADO CORRECTAMENTE";
        ...
        $sql = new Sql;
        echo "NO SE PUDO MANDAR EL EMAIL A larondaong@gmail.com";
    ...
    $mail2->AddAddress('defelicerafael@gmail.com'); 
    ...
    if($estadoEnvio2){
        echo "EMAIL A ".$email." ENVIADO CORRECTAMENTE";
    }else{
        echo "NO SE PUDO MANDAR EL EMAIL A ".$email;
    }     
